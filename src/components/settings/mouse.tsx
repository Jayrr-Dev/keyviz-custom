...
import {
  ...
  CursorEdit01Icon,
  CursorMagicSelection03FreeIcons,
  Drag03Icon,
  KeyboardIcon,
  Link02Icon,
  ...
  return (
    <div className="flex flex-col gap-y-4 p-6">
      ...
      <Item variant="muted">
        <ItemContent>
          <ItemTitle>
            <HugeiconsIcon icon={CursorMagicSelection03FreeIcons} size="1em" />{" "}
            Show Clicks
          </ItemTitle>
          <ItemDescription>
      ...
      <ItemGrid>
        <Item variant="muted">
          <ItemContent>
            <ItemTitle>
              <HugeiconsIcon icon={CursorCircleSelection01Icon} size="1em" />{" "}
              Size
            </ItemTitle>
          </ItemContent>
          <ItemActions>
      ...
      <Item variant="muted">
        ...
        <ItemActions>
          <Switch
            ...
            onCheckedChange={(keepHighlight) =>
              setMouseStyle({ keepHighlight })
            }
            disabled={!mouse.showClicks}
          />
        </ItemActions>
      ...
      <Item variant="muted">
        <ItemContent>
          <ItemTitle>
            <HugeiconsIcon icon={MouseLeftClick05Icon} size="1em" /> Show
            Indicator
          </ItemTitle>
          <ItemDescription>
            Show the current click next to the cursor
          </ItemDescription>
        </ItemContent>
        <ItemActions>
          <Switch
      ...
      <Item variant="muted">
        <ItemContent>
          <ItemTitle>
            <HugeiconsIcon icon={KeyboardIcon} size="1em" /> Style
          </ItemTitle>
          <ItemDescription>
            Mouse icons next to the cursor. Key placement is in Appearance.
          </ItemDescription>
        </ItemContent>
        <ItemActions>
          <Select
            value={mouse.indicatorStyle ?? "keyboard"}
            onValueChange={(indicatorStyle: "keyboard" | "mouse") =>
              setMouseStyle({ indicatorStyle })
            }
      ...
      <Item variant="muted">
        ...
        <ItemActions>
          <Switch
            ...
            onCheckedChange={(keepIndicator) =>
              setMouseStyle({ keepIndicator })
            }
            disabled={!mouse.showIndicator}
          />
        </ItemActions>
            ...
            onChange={
              offsetLinked
                ? (indicatorOffsetX) => {
                    ...
                    setMouseStyle({ indicatorOffsetY: indicatorOffsetX });
                  }
                : (indicatorOffsetX) => setMouseStyle({ indicatorOffsetX })
            }
            step={1}
