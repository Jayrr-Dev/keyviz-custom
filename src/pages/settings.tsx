...
const sideBar = [
  ...
  { title: "Hotkey Labels", icon: KeyboardIcon },
  { title: "Draw Mode", icon: CursorEdit01Icon },
];
    ...
    <div className="flex w-screen h-screen overflow-hidden border-t bg-background">
      <div className="w-44 p-2 flex flex-col gap-y-1 rounded-xl">
        ...
        <div className="mt-auto flex gap-2 items-center">
          ...
          >
            <SidebarItem
              item={{ title: "About", icon: InformationSquareIcon }}
      ...
      <ScrollArea className="flex-1 relative">
        ...
        {activeTab === "Hotkey Labels" && <LabelingHotkeys />}
        {activeTab === "Draw Mode" && <DrawingMode />}
